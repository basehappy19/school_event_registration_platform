        ...
        {!session ? (
          <div className="text-center py-8">
            ...
            <form action={signInWithGoogle}>
              <button 
                type="submit"
                className="bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-semibold py-3 px-6 rounded-xl transition-all shadow-sm flex items-center justify-center mx-auto cursor-pointer"
              >
