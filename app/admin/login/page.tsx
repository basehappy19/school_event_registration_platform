  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-8 max-w-sm w-full text-center">
        ...
        <p className="text-slate-500 mb-8 text-sm">Secure access requires authentication via Google Workspace.</p>
        ...
        >
          <button type="submit" className="w-full bg-slate-900 hover:bg-black text-white font-semibold py-3.5 px-4 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2">
        ...
        <p className="mt-8 text-xs text-slate-400">If you are not an administrator, please return to the <a href="/" className="text-indigo-600 hover:underline">Home Page</a>.</p>
      </div>
    </div>
  )
}
